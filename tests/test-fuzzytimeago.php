...
class FuzzyTimeAgoTest extends WP_UnitTestCase {
	...
	public function test_over_multiple_years() {
		...
		$this->assertSame( $subject->over_rough_period(), 'over 10 years ago' );
	}
}
